...
/*
 * Turns certain LEDs on depending on the numeric character from [1, 9) or turns all LEDs off if a character outside of the accepted values is sent though the terminal
 */
...
__interrupt void ADC10_ISR(void) {
    // PROBLEM 5
    if (rechar == 49) {     // ASCII character '1'
        P1OUT &= 0x11;
    } else if (rechar == 50) {      // ASCII character '2'
        P1OUT &= 0x21;
    } else if (rechar == 51) {      // ASCII character '3'
        P1OUT &= 0x31;
    } else if (rechar == 52) {      // ASCII character '4'
        P1OUT &= 0x41;
    } else if (rechar == 53) {      // ASCII character '5'
        P1OUT &= ~0x11;
    } else if (rechar == 54) {      // ASCII character '6'
        P1OUT &= ~0x21;
    } else if (rechar == 55) {      // ASCII character '7'
        P1OUT &= ~0x31;
    } else if (rechar == 56) {      // ASCII character '8'
        P1OUT &= ~0x41;
    } else {
        P1OUT &= ~0xff;
    }
