...
/*
 * Samples A6, A3, and A0 every 1ms using the ADC's Data Transfer Controller (DTC)
 * Converts the sampled channels to mV and prints to the terminal every 250ms
 * Also blinks an LED every 250ms
 */
