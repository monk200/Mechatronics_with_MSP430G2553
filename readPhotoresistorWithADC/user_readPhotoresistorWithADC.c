...
/*
 * Uses ADC0 to read from a photoresistor and turns on an LED while the lights in the room are off
 * This program requires tuning the value in line 102 to be the value of ambient light when all the lights in the room are off
 */
